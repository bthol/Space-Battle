const user = {
    ...
    lazercannon: {baseDamage: 30, baseCharge: 5, overDamage: 50, overCharge: 8, accuracy: .9}
};

const aliens = [
    {name: "Subort", maxHealth: 20, score: 100, damage: 10, accuracy: .4},
    {name: "Tankbug", maxHealth: 80, score: 400, damage: 20, accuracy: .3},
...
const bosses = [
    ...
    {name: "Harvester", maxHealth: 150, score: 10000, damage: 45, accuracy: .3},
    {name: "Mantlebrot", maxHealth: 200, score: 10000, damage: 40, accuracy: .4},
    {name: "Liminal", maxHealth: 250, score: 20000, damage: 60, accuracy: .3},
];
