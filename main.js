    ...
    if (shieldCharge >= user.shield.rechargeTime) {
        if (user.shield.level < user.shield.maxLevel) {
            ...
            if (user.shield.maxLevel - user.shield.level < user.shield.rechargeAmmount) {
                alert(`Shield regenerated by ${user.shield.rechargeAmmount - (user.shield.maxLevel - user.shield.level)}`);
                user.shield.level += user.shield.rechargeAmmount - (user.shield.maxLevel - user.shield.level);
            } else {
                user.shield += user.shield.rechargeAmmount;
